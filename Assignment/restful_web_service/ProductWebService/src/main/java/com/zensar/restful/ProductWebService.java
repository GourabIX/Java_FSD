...
public class ProductWebService {
	...
	@POST							// If FormParam is used, GET cannot be used. Only POST must be used.
	@Path("/pricerange")
	@Produces({MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML})
	public List<Product> getByPriceRange(@FormParam("min") double minPrice, @FormParam("max") double maxPrice)
	{
