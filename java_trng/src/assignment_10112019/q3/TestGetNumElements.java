package assignment_10112019.q3;

import java.util.HashSet;
import java.util.Set;

public class TestGetNumElements {
	...
	public static void main(String[] args) {
		...
		GetNumElements sizeGetter = new GetNumElements();
		System.out.println("Size of gameChars HashSet: " + sizeGetter.getHsLength(gameChars));
